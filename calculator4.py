## Do not change the indent setting of code , it may result in misbehaviour of application . All Code is made in PyQt5 and methods include test cases to fail the functionality.
#for any queries contact 'aditya.agashe1234@gmail.com'.
